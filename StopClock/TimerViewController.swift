...
//  StopClock
//
//  Created by Damodar Namala on 23/08/22.
//
...
extension TimerViewController {
    ...
    private func applayStyles() {
        self.backgroundView?.applayCornerRadius()
        self.startButton?.applayShadow()
        self.stopButton?.applayShadow()
